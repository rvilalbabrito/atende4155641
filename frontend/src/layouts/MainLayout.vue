    ...
    <q-header class="bg-white text-grey-8 q-py-xs "
      ...
      <q-toolbar>
        ...
        <q-btn flat
          ...
          class="q-ml-sm"
          v-if="$q.screen.gt.xs">
          <q-img src="/InfoAtendimentos-logo.png"
        ...
        <div class="q-gutter-sm row items-center no-wrap">
          <q-btn round
            ...
            <q-badge color="red"
              text-color="white"
              floating  v-if="( parseInt(notifications.count) + parseInt(notifications_p.count) ) > 0">
...
export default {
  ...
  data () {
    return {
      username,
      domainExperimentalsMenus: ['@atendimentos.info'],
      miniState: true,
      userProfile: 'user',
      modalUsuario: false,
      usuario: {},
